...
def search_radioactive_substance(
    ...
    """Searches DEFRA environment API radioactive substance registry"""
    try:
        url = f"{__BASE_URL}/radioactive-substance/registration.json"
        params = {}
        if number_search:
...
def search_for_radioactive_substance(
    id: str,
) -> str:
    """Searches DEFRA environment API radioactive substance registry for a particular registration"""
    try:
        url = f"{__BASE_URL}/radioactive-substance/registration/{id}.json"
